...
const convertEmojis = (text) => Effect.try({
    try: () => {
        let result = text;
    ...
    catch: (error) => new TextCleaningError(`Emoji conversion failed: ${error}`, "EMOJI_CONVERSION_FAILED", "NORMALIZATION"),
});
...
export const convertEmojiToSpanish = (emoji) => {
